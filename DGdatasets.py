...
class MultipleEnvironmentMNIST(MultipleDomainDataset):
    def __init__(self, root, environments, dataset_transform, input_shape,
        ...
        for i in range(len(environments)):
            ...
            self.datasets.append(dataset_transform(images, labels, environments[i]))  # a list of TensorDataset
...
class MultipleEnvironmentImageFolder(MultipleDomainDataset):
    def __init__(self, root):
        ...
        transform = transforms.Compose([
            transforms.Resize((64, 64)), # transforms.Resize((224, 224)),
            transforms.ToTensor(),
            normalize
        ])
    ...
    def __init__(self, root, superclass, test_envs, category_dict, hparams):
        ...
        for i, env_name in enumerate(self.ENVIRONMENTS):
            ...
            csv_file_path = os.path.join(
                f'/home/ma-user/work/IIRM/NICO_settings/{split_name}/{superclass}_{env_name}.csv')
            self.datasets.append(
                NICOEnvironment(f'{root}/nico/{superclass}/images', csv_file_path, self.input_shape, env_transform,
                                category_dict))
...
class CUB_200_normal(MultipleDomainDataset):
    ...
    def __init__(self, root, test_envs, hparams):
        ...
        tr_dataset = CUB_200(f'{root}/CUB_200/images', 'cub200_dataset/annotation.csv', 'cub200_dataset/attributes',
                             'cub200_dataset/train_id.txt', 7, transform=tr_transform)
        te_dataset = CUB_200(f'{root}/CUB_200/images', 'cub200_dataset/annotation.csv', 'cub200_dataset/attributes',
                             'cub200_dataset/test_id.txt', 7, transform=te_transform)
...
class CUB_200_bill_shape(MultipleDomainDataset):
    ...
    def __init__(self, root, test_envs, hparams):
        ...
        tr_dataset = CUB_200(f'{root}/CUB_200/images', 'cub200_dataset/annotation.csv', 'cub200_dataset/attributes',
                             'cub200_dataset/train_id.txt', attr_id, transform=tr_transform)
        te_dataset = CUB_200(f'{root}/CUB_200/images', 'cub200_dataset/annotation.csv', 'cub200_dataset/attributes',
                             'cub200_dataset/test_id.txt', attr_id, transform=te_transform)
